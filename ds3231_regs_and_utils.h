...
#define EN32KHZ_FLAG		(EN32KHZ_MASK << EN32KHZ_FLAG_POS)
...
/* Alarm 2 Flag (A2F) */
#define A2F_FLAG_MASK		(0x01)
#define A2F_FLAG_POS		(0x01)
#define A2F_FLAG			(A2F_FLAG_MASK << A2F_FLAG_POS)

/* Alarm 1 Flag (A2F) */
#define A1F_FLAG_MASK		(0x01)
#define A1F_FLAG_POS		(0x00)
#define A1F_FLAG			(A1F_FLAG_MASK << A1F_FLAG_POS)
